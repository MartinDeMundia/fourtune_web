        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Fourtune Coins" md-sort-by="fourtune_coins">{{item.fourtune_coins}}</md-table-cell>
              <md-table-cell md-label="Registration Date" md-sort-by="created_at">{{item.created_at}}</md-table-cell>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      table: [],
      footerTable: ["Name", "Email", "Phone","Fourtune Coins","Created At", "Actions"],
    ...
    methods: {
      ...
      getList() {
          ...
          return axios.post(`${url}/get-users`, params, options)
          .then(response => { 
                  this.table = response.data.users;
         });   
