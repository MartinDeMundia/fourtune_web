...
<script>
  import UserEditCard from "@/pages/Dashboard/Main/EditProfileCard.vue";
  import UserPasswordCard from "@/pages/Dashboard/Main/EditPasswordCard.vue";
  import UserProfileCard from "@/pages/Dashboard/Main/UserProfileCard.vue";
