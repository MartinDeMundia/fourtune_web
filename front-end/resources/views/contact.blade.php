@include('header')
      <!-- - PAGE HEADER -->
      <!-- PAGE MAIN -->
      <div class="js-smooth-scroll bg-light-1" id="page-wrapper" data-barba="container" style="height:auto !important;width:auto !important;">
              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col-lg-8">
                  ...
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="mt-0 mb-0 h2">Lets get this conversation started.</h1>
                  </div>
                  <div class="w-100"></div>
              ...
              <div class="container-fluid no-gutters">
                <div class="row no-gutters">
                  <div class="col-lg-auto col-12">
                    <div class="bg-white container-fluid py-md-3 py-1">
                      <div class="section-properties__item my-2">
                        <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                          <div class="figure-info__option small-caps">Fourcus Group Limited</div>
                          <div class="figure-info__value paragraph">254<br>Nairobi<br>Kenya</div>
                        </div>
                      </div>
                      <div class="section-properties__item my-2">
                        <div class="figure-info split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                          <div class="figure-info__option small-caps">Want to Talk?</div>
                          <div class="figure-info__value paragraph">
                          <a href="#">
                              info@fourtune.com</a>
                          <br>+254 727 310 743
                          <br>+254 727 000 000
          ...
          <section class="section section-content clearfix pt-medium pb-small text-center" data-arts-os-animation="data-arts-os-animation">
            <div class="section-content__inner">
              ...
              <div class="section-content__text split-text js-split-text mt-1" data-split-text-type="lines" data-split-text-set="lines">
                <p>Emter you email address and we will connect you with the right person</p>
              </div>
            </div>
          </section>
          <!-- - section CONTENT #1 -->
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <section class="section section-form pb-medium">
                  <form class="form form-contact js-ajax-form bg-white form-contact_paddings" action="https://artemsemkin.com/rhye/html/mail.php" method="POST" data-message-success="Thanks for your message! We will reply you as soon as possible." data-message-error="Something went wrong :( Please contact me directly at &lt;a href=_rhye%40example.com__rhye%40example.com_/a__.html>
                    <!-- header -->
