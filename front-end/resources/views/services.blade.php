              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col-lg-8">
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="mt-0 mb-0 h1">Services II</h1>
                  </div>
                  <div class="w-100"></div>
                  ...
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/rings.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Weddings</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-sm-6 col-gutters">
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/girl-photography.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Portraits</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-sm-6 col-gutters">
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/value.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Commercial</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-sm-6 col-gutters">
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/studio-lighting.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Studio</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-sm-6 col-gutters">
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/magazine.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Reportages</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-sm-6 col-gutters">
                  <div class="section-grid__item">
                    <div class="figure-feature bg-white">
                      <div class="figure-feature__header">
                        <!-- icon -->
                        <div class="figure-feature__icon"><img src="img/assets/sectionServices/inauguration.svg" alt="alt"></div>
                        <!-- - icon -->
                        <!-- header -->
                        <div class="figure-feature__heading h4 mt-0-5 mb-0">Corporate</div>
                        <!-- - header -->
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="container figure-testimonial">
                      <div class="row justify-content-between align-items-center">
                          ...
                          <div class="overflow figure-testimonial__avatar">
                            <div class="w-100 h-100" data-swiper-parallax-zoom="20%" data-swiper-parallax="20%">
                              ...
                              <div class="slider__zoom-container w-100 h-100">
                                <div class="slider__bg swiper-lazy" data-background="img/assets/sectionTestimonials/client-1.jpg"></div>
                              </div>
                              <!-- - zoom on drag container -->
                            </div>
                          </div>
                        ...
                        <div class="col pl-md-3">
                          <div class="figure-testimonial__sign"><img src="img/general/quote-black.svg" alt="alt"></div>
                        ...
                        <div class="col-lg-auto col-12">
                          <div class="overflow figure-testimonial__avatar">
                            <div class="w-100 h-100" data-swiper-parallax-zoom="20%" data-swiper-parallax="20%">
                              <!-- zoom on drag container -->
                              <div class="slider__zoom-container w-100 h-100">
                                <div class="slider__bg swiper-lazy" data-background="img/assets/sectionTestimonials/client-2.jpg"></div>
                              </div>
                              <!-- - zoom on drag container -->
                            </div>
                          </div>
                        ...
                        <div class="col-lg-auto col-12">
                          <div class="overflow figure-testimonial__avatar">
                            <div class="w-100 h-100" data-swiper-parallax-zoom="20%" data-swiper-parallax="20%">
                              <!-- zoom on drag container -->
                              <div class="slider__zoom-container w-100 h-100">
                                <div class="slider__bg swiper-lazy" data-background="img/assets/sectionTestimonials/client-3.jpg"></div>
                              </div>
                              <!-- - zoom on drag container -->
                            </div>
                          </div>
                        ...
                        <div class="col-lg-auto col-12">
                          <div class="overflow figure-testimonial__avatar">
                            <div class="w-100 h-100" data-swiper-parallax-zoom="20%" data-swiper-parallax="20%">
                              <!-- zoom on drag container -->
                              <div class="slider__zoom-container w-100 h-100">
                                <div class="slider__bg swiper-lazy" data-background="img/assets/sectionTestimonials/client-4.jpg"></div>
                              </div>
                              <!-- - zoom on drag container -->
                            </div>
                          </div>
                        ...
                        <div class="col-lg-auto col-12">
                          <div class="overflow figure-testimonial__avatar">
                            <div class="w-100 h-100" data-swiper-parallax-zoom="20%" data-swiper-parallax="20%">
                              <!-- zoom on drag container -->
                              <div class="slider__zoom-container w-100 h-100">
                                <div class="slider__bg swiper-lazy" data-background="img/assets/sectionTestimonials/client-5.jpg"></div>
                              </div>
                              <!-- - zoom on drag container -->
                            </div>
                          </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-8">
                      ...
                      <div class="section-content__text split-text js-split-text mt-1" data-split-text-type="lines" data-split-text-set="lines">
                        <p>Too horrible consider followed may differed age. An rest if more five mr of. Age just her rank met down way. Attended required so in cheerful an. Domestic replying she resolved him for did. Rather in lasted no within no.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="section-video__container section section_h-700 section-content__image"><a class="section-video__link" href="img/assets/sectionVideo/video-1.mp4" data-autoplay="data-autoplay">
                ...
                <div class="section__bg">
                  <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                    <div>
                      <div class="lazy-bg" data-src="img/assets/project6/img-6-5.jpg"></div>
                    </div>
                  </div>
